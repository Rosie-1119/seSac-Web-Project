		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="store" class="col-md-11">
					...
					<div align="left">
						TOTAL PRODUCTS : ${fn:length(list) }<br>
					</div>
					...
					<div class="row">
						...
						<c:forEach items="${ list }" var="list" varStatus="status">
							<div class="col-md-4 col-xs-7">
								<div class="product"
									style="width: 357.5px; height: 509.77px; padding: 10px;">
									<div class="product-img">
										<%-- 이미지 링크하기 --%>

										<img
											src="${ pageContext.request.contextPath }/upload/${ list.fileSaveName }"
											alt="">
									...
									<div class="add-to-cart">
										<a
											href="${ pageContext.request.contextPath }/auction/viewcnt.do?no=${ list.pdNo }">
											<button class="add-to-cart-btn">
												<i class="fa fa-hand-o-up"></i>경매 참여
											</button>
										</a>
									</div>
