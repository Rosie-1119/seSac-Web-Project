                  ...
                  <div class="billing-details">
                     ...
                     <div class="form-group">
                        <input class="input" type="password" name="pwd" id="pwd"
                           placeholder="바꾸실 패스워드를 입력해 주세요." required>
                     </div>
                     <div class="form-group">
                        <input class="input" type="password" name="pwdCheck" id="pwd2"
                           placeholder="바꾸실 패스워드를 다시 입력해 주세요." required>
                           <span id="pwdCheck"> </span>
                     </div>
                     
                     <div class="form-group">
                        <input class="input" type="tel" name="phone"
                           placeholder="수정하실 휴대폰 번호 '-'표 없이 입력해 주세요." required>
                     </div>
                     <div class="form-group">
                        <input class="input" type="email" name="email"
                           placeholder="수정하실 이메일을 입력해 주세요." required>
                     </div>
                     <div class="form-group">
                        <button class="primary-btn order-submit" id="signBtn">수정하기</button>
