...
function goWriteForm() {
   ...
   function doAction(boardNo) {
      ...
      if (confirm('로그인 서비스가 필요합니다\n로그인 페이지로 이동하시겠습니다?')) {
         location.href = '${ pageContext.request.contextPath }/jsp/login.do'
      }
      </c:otherwise>
      </c:choose>
   }
												...
												<ul class="reviews">
													<li>
														...
														<c:forEach items="${ list }" var="board">
															<h5 class="no"> no. ${ board.no }</h5>
															<h5 class="id"> ${ board.id }</h5>
										...
										<div class="col-md-3">
											<div id="review-form">
												<form class="review-form">
													작성자 : ${ userVO.id }<br>
													제목 : <input class="input" type="email" placeholder="제목을 입력하세요">
													내용 : 
													<textarea class="input" placeholder="본문을 입력하세요"></textarea>
													
													<button class="primary-btn" name="submit" onclick="">등록</button><br>
													<button>수정</button>
													<button>삭제</button>
													<button>답글</button>
												</form>
