						...
						<div class="store-filter clearfix">
							...
							<ul class="store-pagination">
								...
								<c:forEach var="item" varStatus="status" begin="${ beginPage }" end="${ endPage }" step="1">
									...
									<c:if test="${ page != item }">
					 					<li><a href="${ pageContext.request.contextPath }/category/electronics.do?page=${ item }">${ item }</a></li>
			               			</c:if>
								...
								<c:if test="${ page < totalPage }">
			 						<li><a href="${ pageContext.request.contextPath }/category/electronics.do?page=${ page + 1 }"><i class="fa fa-angle-right"></i></a></li>
			           			</c:if>
