...
<html lang="en">
	...
	<body>
		...
		<header>
			...
			<div id="top-header">
				<div class="container">
					...
					<!-- 회원가입 버튼 -->
						<li><a href="${ pageContext.request.contextPath }/member/signup.do"><i class="fa fa-arrow-right"></i> Join</a></li>
					<!-- 로그인 버튼 -->
						<li><a href="${ pageContext.request.contextPath }/member/login.do"><i class="fa fa-user-o"></i> Login</a></li>
					</ul>
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												<p class="product-category">카테고리</p>
												<h3 class="product-name"><a href="#">물품2</a></h3>
												<h4 class="product-price">시작가 27,000원</del></h4>
										...
										<div class="product">
											...
											<div class="product-body">
												<p class="product-category">카테고리</p>
												<h3 class="product-name"><a href="#">물품3</a></h3>
												<h4 class="product-price">시작가 108,000원</del></h4>
										...
										<div class="product">
											...
											<div class="product-body">
												<p class="product-category">카테고리</p>
												<h3 class="product-name"><a href="#">물품5</a></h3>
												<h4 class="product-price">시작가 77,000원</del></h4>
		...
		<!-- 이 부분은 카테고리별로 위와 같이 가장 많이 제시받은 순서대로 넣을 수 있음 -> 아직 미정(위의 top suggested 기능 확보 후 추가) -->
		<!-- SECTION -->
		<div class="section">
			<!-- container -->
			<div class="container">
